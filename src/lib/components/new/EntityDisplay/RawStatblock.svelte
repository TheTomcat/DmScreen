<script lang="ts">
	...
	export let entity: Entity | Omit<Entity, 'entity_id'> | undefined;
...
{:else}
	<div class="container overflow-scroll">
		<h1 class="text-xl">{entity.name}</h1>
		<h3 class="text-sm">{renderSize(renderData)} {renderType(renderData)}</h3>
