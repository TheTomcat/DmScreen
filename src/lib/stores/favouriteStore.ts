...
import type { Collection, Image } from "../../app";
import { get, writable } from "svelte/store";
import client from "$lib/api/index";

export type Favourite = Collection | Image;
...
const compare = (item1: Favourite, item2: Favourite): boolean => {
...
export const contains = (item: Favourite) => {
